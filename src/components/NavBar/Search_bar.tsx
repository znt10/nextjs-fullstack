...
export default function Bar() {
    return (
        ...
        <div className="flex justify-between gap-6 bg-gray-800 bg-opacity-50 p-4 rounded-lg shadow-lg">
            <Link href="/dashboard" className="text-white hover:text-yellow-300 transition-colors">Home</Link>
