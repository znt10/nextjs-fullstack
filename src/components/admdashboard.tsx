            ...
            <div className="flex flex-1">
                ...
                <aside className="bg-white w-64 border-r shadow-sm p-6 flex flex-col gap-4">
                    <button
                        ...
                        className={`flex items-center gap-3 p-2 rounded-lg hover:bg-blue-100 ${selectedSection === "overview" ? "bg-blue-100 font-semibold" : ""
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`flex items-center gap-3 p-2 rounded-lg hover:bg-blue-100 ${selectedSection === "empresas" ? "bg-blue-100 font-semibold" : ""
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`flex items-center gap-3 p-2 rounded-lg hover:bg-blue-100 ${selectedSection === "candidatos" ? "bg-blue-100 font-semibold" : ""
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`flex items-center gap-3 p-2 rounded-lg hover:bg-blue-100 ${selectedSection === "config" ? "bg-blue-100 font-semibold" : ""
                            }`}
                    >
